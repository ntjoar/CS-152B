...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btns }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { trig }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
